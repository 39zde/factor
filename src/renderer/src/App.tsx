...
import type { AppContextType, AppSettingsType, AppSettingsChange, AppAction, AppSolidsType } from '@util/App';

import './App.css';

const ImportWorker = (() => {
	const work = new Worker(new URL('@util/worker/import.worker.ts', import.meta.url), {
		type: 'module',
	});
	return work;
})();
